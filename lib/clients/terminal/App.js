...
App.prototype.createAndSubscribe = async function() {
	...
	editPage = new EditPage( {
		...
		fields: [
			...
			{ key: 'description' , label: "Description: " , height: 5 } ,
			{ key: 'tags' , label: "Tags: " }
		]
	} ) ;
...
App.prototype.editList = async function( list ) {
	...
	editPage = new EditPage( {
		...
		fields: [
			...
			{
				key: 'description' , label: "Description: " , height: 5 , content: list.description
			} ,
...
App.prototype.editItem = async function( list , item ) {
	...
	editPage = new EditPage( {
		...
		fields: [
			...
			{
				key: 'description' , label: "Description: " , height: 5 , content: item.description
			} ,
			{
				key: 'status' ,
				label: "Status: " ,
